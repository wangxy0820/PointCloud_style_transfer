...
class UnsupervisedTester:
    ...
    def load_model(self, checkpoint_path: str):
        """加载无监督模型"""
        print(f"Loading unsupervised model from {checkpoint_path}")
...
def main():
    parser = argparse.ArgumentParser(description='Test Unsupervised Point Cloud Style Transfer Model')
    ...
    output_dir = os.path.join(args.output_dir, f"test_unsupervised_{timestamp}")
    os.makedirs(output_dir, exist_ok=True)
